...
class FieldsTest < ApplicationSystemTestCase
  ...
  test "creating a Field" do
    ...
    fill_in "Arena", with: @field.arena_id
    fill_in "Label", with: @field.label
    fill_in "Max players", with: @field.max_players
    fill_in "Min players", with: @field.min_players
    fill_in "Sport", with: @field.sport_id
