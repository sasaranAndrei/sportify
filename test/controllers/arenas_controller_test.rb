...
class ArenasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arena" do
    assert_difference('Arena.count') do
      post arenas_url, params: { arena: { location: @arena.location, phone_number: @arena.phone_number, title: @arena.title } }
    end
  ...
  test "should update arena" do
    patch arena_url(@arena), params: { arena: { location: @arena.location, phone_number: @arena.phone_number, title: @arena.title } }
